                ...
                <div class="form">
                    <form  method="POST" action="DispatchServlet" 
                        ...
                        <input class="form-control" type="text" name="txtProductName" 
                               ...
                               maxlength="50" />
                        <c:if test="${not empty requestScope.ERROR_PRODUCTNAME}">
                            <div class="text-center">
                                <p style="color: red;font-weight: bold">${requestScope.ERROR_PRODUCTNAME}</p>
                            </div>
                        </c:if>
                        ...
                        <input type="file" class="form-control-file border"  id="upload" onchange="getImage()"
                               name="file" required accept=".png, .jpg, .jpeg"
                               />
                        <div class="text-center">
                            <div id="displayImg" >
                        ...
                        <input class="form-control" type="number" name="txtPrice" 
                               ...
                               placeholder="Price" required step="0.01" min="0" max="1000"
                               maxlength="50" /> 
