                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="paymentMethod" id="exampleRadios1" value="Cash" checked>
                                <label class="form-check-label" for="exampleRadios1">
                                    Cash
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="paymentMethod" id="exampleRadios2" value="Paypal">
                        ...
                        <div class="col-lg-4">
                            ...
                            <a href="${cancel}" class="btn btn-warning form-control">Cancel Payment</a>
                        </div>
                    </div>
                </form>
            </c:if>
